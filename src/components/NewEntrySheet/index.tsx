...
export interface IEntry {
    ...
    minutes: string;
    remarks: string;
    id:number; // added for  the unique id
}
...
export const NewEntrySheet: React.FC<INewEntrySheet> = (props: INewEntrySheet) => {
    ...
    const [remarks, setRemarks]=React.useState('');const deletecard = ()=>{
        ...
        <div className="new-entry-sheet">
            ...
            <div className="sheet-footer">
                <div className="action-group">
                    <Button className="btn btn--primary" color="primary" onClick={onAddEntry}  disabled= { checkkr()}  >
                        Add Entry
                    </Button>
                </div>
            </div>
